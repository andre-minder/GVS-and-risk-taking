...
expName = 'GDT_trials'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    if dataDir is None:
        dataDir = _thisDir
    filename = "data/sub-{sub}_task-gameofdicetask_beh".format(sub = expInfo['participant'])
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\PsychoPy\\GDT\\GDT_trials_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    text_welcome = visual.TextStim(win=win, name='text_welcome',
        text='Herzlich Willkommen zum zweiten Verhaltensexperiment!\n\nAuch in diesem Experiment ist es Ihr Ziel, möglichst viel Geld zu sammeln. Wir erklären Ihnen im Folgenden das Experiment.\n',
        font='Open Sans',
    ...
    continue_welcome = visual.TextBox2(
         ...
         pos=(0.9, -0.97),units='norm',     letterHeight=0.05,
    ...
    box_dice_instructions = visual.TextBox2(
         ...
         flipHoriz=False, flipVert=False, languageStyle='LTR',
         editable=False,
         name='box_dice_instructions',
         depth=-1, autoLog=True,
    )
    img_dice_throw_instructions = visual.ImageStim(
        win=win,
        name='img_dice_throw_instructions', units='norm', 
    ...
    text_gain_instructions = visual.TextBox2(
         win, text='Gewinn / Verlust: ', placeholder='Type here...', font='Open Sans',
         pos=(-0.10, 0.7),units='norm',     letterHeight=0.08,
         ...
         flipHoriz=False, flipVert=False, languageStyle='LTR',
         editable=False,
         name='text_gain_instructions',
         depth=-3, autoLog=True,
    )
    value_gain_instructions = visual.TextBox2(
         win, text='0 Franken', placeholder='Type here...', font='Open Sans',
         ...
         flipHoriz=False, flipVert=False, languageStyle='LTR',
         editable=False,
         name='value_gain_instructions',
         depth=-4, autoLog=True,
    )
    text_bank_instructions = visual.TextBox2(
         win, text='Guthaben:', placeholder='Type here...', font='Open Sans',
         ...
         flipHoriz=False, flipVert=False, languageStyle='LTR',
         editable=False,
         name='text_bank_instructions',
         depth=-5, autoLog=True,
    )
    value_bank_instructions = visual.TextBox2(
         win, text='1000 Franken', placeholder='Type here...', font='Open Sans',
    ...
    text_instructions_center = visual.TextStim(win=win, name='text_instructions_center',
        ...
        languageStyle='LTR',
        depth=-7.0);
    text_bottom_instructions = visual.TextStim(win=win, name='text_bottom_instructions',
        text='',
        font='Open Sans',
        units='norm', pos=(0, -0.3), height=0.07, wrapWidth=1.5, ori=0.0, 
        color='black', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-8.0);
    text_right_instructions = visual.TextStim(win=win, name='text_right_instructions',
        text='',
        font='Open Sans',
        units='norm', pos=(0.2, 0.55), height=0.07, wrapWidth=1.3, ori=0.0, 
        color='black', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-9.0);
    ...
    img_dice_grid = visual.ImageStim(
        win=win,
        name='img_dice_grid', units='norm', 
        image='images/dice_grid_white.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, -0.4), size=(2, 1.2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=64.0, interpolate=True, depth=-11.0)
    back_instructions = visual.TextBox2(
         win, text='Zurück', placeholder='Type here...', font='Arial',
         pos=(0.7, -0.97),units='norm',     letterHeight=0.05,
         size=(0.2, 0.2), borderWidth=3.0,
         color='black', colorSpace='rgb',
         opacity=None,
         bold=True, italic=False,
    ...
    text_start = visual.TextStim(win=win, name='text_start',
        text='Sie werden nun die Möglichkeit haben, einige Male zu würfeln, damit Sie sich an das Experiment gewöhnen können.\n\n',
        font='Open Sans',
        units='norm', pos=(0, 0), height=0.08, wrapWidth=None, ori=0.0, 
        color='black', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    WelcomeComponents = [text_welcome, continue_welcome, mouse_welcome]
    ...
    while continueRoutine:
        ...
        if mouse_welcome.getPressed()[0] == 0 and mouseIsDown:
            mouseIsDown = False
    ...
    text_instructions = 0
    box_dice_instructions.reset()
    text_gain_instructions.reset()
    value_gain_instructions.reset()
    text_bank_instructions.reset()
    value_bank_instructions.reset()
    ...
    # keep track of which components have finished
    InstructionsComponents = [box_dice_instructions, img_dice_throw_instructions, text_gain_instructions, value_gain_instructions, text_bank_instructions, value_bank_instructions, text_instructions_center, text_bottom_instructions, text_right_instructions, mouse_instructions, img_dice_grid, back_instructions, continue_instructions]
    ...
    while continueRoutine:
        ...
        if text_instructions == 0:
            text_center = ""
            text_right = "Oben links sehen Sie einen Würfel. Mit diesem Würfel werden Sie in diesem Experiment mehrmals würfeln. Dieser Würfel enthält die Zahlen 1 bis 6. Die Wahrscheinlichkeit eine bestimmte Zahl zu würfeln, ist für alle Zahlen gleich."
            box_dice_instructions.draw()
            img_dice_throw_instructions.draw()
            img_dice_grid.draw()
        elif text_instructions == 1:
            text_center = ""
            text_right = "Unterhalb des Würfels sehen Sie verschiedene Würfelkombinationen. Vor jedem Würfelwurf dürfen Sie sich einer dieser Kombinationen aussuchen. Ist die gewürfelte Zahl Teil der Kombination, erhalten Sie denn Betrag rechts von der Würfelkombination. Ist die gewürfelte Zahl nicht in der Würfelkombination zu finden, verlieren Sie den Betrag auf der rechten Seite. Wenn Sie zum Beispiel eine Kombination mit 2 Würfeln auswählen, gewinnen oder verlieren Sie 500 Franken."
            box_dice_instructions.draw()
            img_dice_throw_instructions.draw()
            img_dice_grid.draw()
            ...
            text_center = ""
            text_bottom = ""
            text_right = "Sie können Sie sich eine Würfelkombination aussuchen, indem Sie diese mit der linken Maustaste anklicken. Nachdem Sie sich eine Würfelkombination ausgesucht haben, können Sie die rechte Maustaste drücken, um zu würfeln."
            box_dice_instructions.draw()
            img_dice_throw_instructions.draw()
            img_dice_grid.draw()
            back_instructions.draw()
            ...
            text_right = ""
            text_bottom = "Sie starten dieses Spiel mit einem Guthaben von 1000.- Franken. Nach jedem Würfelwurf wird Ihnen der entsprechende Betrag gutgeschrieben oder abgezogen. Ihr momentanes Guthaben sehen Sie immer rechts vom Würfel. \n \n Oberhalb davon sehen Sie jeweils den Betrag, den Sie nach dem Würfeln gewonnen oder verloren haben."
            text_center = ""
            box_dice_instructions.draw()
            img_dice_throw_instructions.draw()
            back_instructions.draw()
            text_gain_instructions.draw()
            value_gain_instructions.draw()
            text_bank_instructions.draw()
            value_bank_instructions.draw()
        ...
        # *box_dice_instructions* updates
        
        # if box_dice_instructions is starting this frame...
        if box_dice_instructions.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            box_dice_instructions.frameNStart = frameN  # exact frame index
            box_dice_instructions.tStart = t  # local t and not account for scr refresh
            box_dice_instructions.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(box_dice_instructions, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'box_dice_instructions.started')
            # update status
            box_dice_instructions.status = STARTED
            box_dice_instructions.setAutoDraw(True)
        
        # if box_dice_instructions is active this frame...
        if box_dice_instructions.status == STARTED:
            # update params
            pass
        
        # if box_dice_instructions is stopping this frame...
        if box_dice_instructions.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > box_dice_instructions.tStartRefresh + 0-frameTolerance:
                # keep track of stop time/frame for later
                box_dice_instructions.tStop = t  # not accounting for scr refresh
                box_dice_instructions.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'box_dice_instructions.stopped')
                # update status
                box_dice_instructions.status = FINISHED
                box_dice_instructions.setAutoDraw(False)
        
        # *img_dice_throw_instructions* updates
        
        # if img_dice_throw_instructions is starting this frame...
        if img_dice_throw_instructions.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            img_dice_throw_instructions.frameNStart = frameN  # exact frame index
            img_dice_throw_instructions.tStart = t  # local t and not account for scr refresh
            img_dice_throw_instructions.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(img_dice_throw_instructions, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'img_dice_throw_instructions.started')
            # update status
            img_dice_throw_instructions.status = STARTED
            img_dice_throw_instructions.setAutoDraw(True)
        
        # if img_dice_throw_instructions is active this frame...
        if img_dice_throw_instructions.status == STARTED:
            # update params
            pass
        
        # if img_dice_throw_instructions is stopping this frame...
        if img_dice_throw_instructions.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > img_dice_throw_instructions.tStartRefresh + 0-frameTolerance:
                # keep track of stop time/frame for later
                img_dice_throw_instructions.tStop = t  # not accounting for scr refresh
                img_dice_throw_instructions.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'img_dice_throw_instructions.stopped')
                # update status
                img_dice_throw_instructions.status = FINISHED
                img_dice_throw_instructions.setAutoDraw(False)
        
        # *text_gain_instructions* updates
        
        # if text_gain_instructions is starting this frame...
        if text_gain_instructions.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            text_gain_instructions.frameNStart = frameN  # exact frame index
            text_gain_instructions.tStart = t  # local t and not account for scr refresh
            text_gain_instructions.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(text_gain_instructions, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'text_gain_instructions.started')
            # update status
            text_gain_instructions.status = STARTED
            text_gain_instructions.setAutoDraw(True)
        
        # if text_gain_instructions is active this frame...
        if text_gain_instructions.status == STARTED:
            # update params
            pass
        
        # if text_gain_instructions is stopping this frame...
        if text_gain_instructions.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_gain_instructions.tStartRefresh + 0-frameTolerance:
                # keep track of stop time/frame for later
                text_gain_instructions.tStop = t  # not accounting for scr refresh
                text_gain_instructions.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text_gain_instructions.stopped')
                # update status
                text_gain_instructions.status = FINISHED
                text_gain_instructions.setAutoDraw(False)
        
        # *value_gain_instructions* updates
        
        # if value_gain_instructions is starting this frame...
        if value_gain_instructions.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            value_gain_instructions.frameNStart = frameN  # exact frame index
            value_gain_instructions.tStart = t  # local t and not account for scr refresh
            value_gain_instructions.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(value_gain_instructions, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'value_gain_instructions.started')
            # update status
            value_gain_instructions.status = STARTED
            value_gain_instructions.setAutoDraw(True)
        
        # if value_gain_instructions is active this frame...
        if value_gain_instructions.status == STARTED:
            # update params
            pass
        
        # if value_gain_instructions is stopping this frame...
        if value_gain_instructions.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > value_gain_instructions.tStartRefresh + 0-frameTolerance:
                # keep track of stop time/frame for later
                value_gain_instructions.tStop = t  # not accounting for scr refresh
                value_gain_instructions.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'value_gain_instructions.stopped')
                # update status
                value_gain_instructions.status = FINISHED
                value_gain_instructions.setAutoDraw(False)
        
        # *text_bank_instructions* updates
        
        # if text_bank_instructions is starting this frame...
        if text_bank_instructions.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            text_bank_instructions.frameNStart = frameN  # exact frame index
            text_bank_instructions.tStart = t  # local t and not account for scr refresh
            text_bank_instructions.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(text_bank_instructions, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'text_bank_instructions.started')
            # update status
            text_bank_instructions.status = STARTED
            text_bank_instructions.setAutoDraw(True)
        
        # if text_bank_instructions is active this frame...
        if text_bank_instructions.status == STARTED:
            # update params
            pass
        
        # if text_bank_instructions is stopping this frame...
        if text_bank_instructions.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_bank_instructions.tStartRefresh + 0-frameTolerance:
                # keep track of stop time/frame for later
                text_bank_instructions.tStop = t  # not accounting for scr refresh
                text_bank_instructions.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text_bank_instructions.stopped')
                # update status
                text_bank_instructions.status = FINISHED
                text_bank_instructions.setAutoDraw(False)
        
        # *value_bank_instructions* updates
        
        # if value_bank_instructions is starting this frame...
        if value_bank_instructions.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            value_bank_instructions.frameNStart = frameN  # exact frame index
            value_bank_instructions.tStart = t  # local t and not account for scr refresh
            value_bank_instructions.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(value_bank_instructions, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'value_bank_instructions.started')
            # update status
            value_bank_instructions.status = STARTED
            value_bank_instructions.setAutoDraw(True)
        
        # if value_bank_instructions is active this frame...
        if value_bank_instructions.status == STARTED:
            # update params
            pass
        
        # if value_bank_instructions is stopping this frame...
        if value_bank_instructions.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > value_bank_instructions.tStartRefresh + 0-frameTolerance:
                # keep track of stop time/frame for later
                value_bank_instructions.tStop = t  # not accounting for scr refresh
                value_bank_instructions.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'value_bank_instructions.stopped')
                # update status
                value_bank_instructions.status = FINISHED
                value_bank_instructions.setAutoDraw(False)
        ...
        # *text_bottom_instructions* updates
        
        # if text_bottom_instructions is starting this frame...
        if text_bottom_instructions.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            text_bottom_instructions.frameNStart = frameN  # exact frame index
            text_bottom_instructions.tStart = t  # local t and not account for scr refresh
            text_bottom_instructions.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(text_bottom_instructions, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'text_bottom_instructions.started')
            # update status
            text_bottom_instructions.status = STARTED
            text_bottom_instructions.setAutoDraw(True)
        
        # if text_bottom_instructions is active this frame...
        if text_bottom_instructions.status == STARTED:
            # update params
            text_bottom_instructions.setText(text_bottom
            , log=False)
        
        # *text_right_instructions* updates
        
        # if text_right_instructions is starting this frame...
        if text_right_instructions.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            text_right_instructions.frameNStart = frameN  # exact frame index
            text_right_instructions.tStart = t  # local t and not account for scr refresh
            text_right_instructions.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(text_right_instructions, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'text_right_instructions.started')
            # update status
            text_right_instructions.status = STARTED
            text_right_instructions.setAutoDraw(True)
        
        # if text_right_instructions is active this frame...
        if text_right_instructions.status == STARTED:
            # update params
            text_right_instructions.setText(text_right
            , log=False)
        ...
        # *img_dice_grid* updates
        
        # if img_dice_grid is starting this frame...
        if img_dice_grid.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            img_dice_grid.frameNStart = frameN  # exact frame index
            img_dice_grid.tStart = t  # local t and not account for scr refresh
            img_dice_grid.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(img_dice_grid, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'img_dice_grid.started')
            # update status
            img_dice_grid.status = STARTED
            img_dice_grid.setAutoDraw(True)
        
        # if img_dice_grid is active this frame...
        if img_dice_grid.status == STARTED:
            # update params
            pass
        
        # if img_dice_grid is stopping this frame...
        if img_dice_grid.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > img_dice_grid.tStartRefresh + 0-frameTolerance:
                # keep track of stop time/frame for later
                img_dice_grid.tStop = t  # not accounting for scr refresh
                img_dice_grid.frameNStop = frameN  # exact frame index
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'img_dice_grid.stopped')
                # update status
                img_dice_grid.status = FINISHED
                img_dice_grid.setAutoDraw(False)
        ...
        if mouse_instructions.getPressed()[0] == 0 and mouseIsDown:
            mouseIsDown = False
    ...
    dice_loop = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('dice_trials.xlsx'),
    ...
    # completed 1.0 repeats of 'dice_loop'
